...
- **KQ rà soát** — bảng tổng hợp theo từng loại dấu hiệu (mỗi dòng: **Chỉ tiêu · Giá trị chưa thuế · Thuế GTGT · Số hóa đơn đã bỏ trùng · Giải thích cách tìm ra**). Gồm: tổng bảng kê; theo từng trạng thái NNT (TMS); HĐ của DN rủi ro; HĐ kê khai trùng; mặt hàng "Không phục vụ SXKD" / "Quà tặng"; HĐ bị thay thế/điều chỉnh/xóa bỏ/không tìm thấy (HĐĐT); rà soát thuế suất 10%/8%. Số hóa đơn được đếm **theo hóa đơn (đã khử trùng dòng)**, không đếm theo dòng.
